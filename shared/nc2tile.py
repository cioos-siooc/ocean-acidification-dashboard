...
GRID_CACHE = None
GRID_CACHE_PATH = os.getenv("GRID_CACHE_PATH", "/opt/data/cache/oa_grid_cache.npz")
INTERP_CACHE = {}
INTERP_CACHE_DIR = os.getenv("INTERP_CACHE_DIR", "/opt/data/cache")
...
def _get_interpolator(method: str, pts_src: np.ndarray, tgt_pts: np.ndarray, grid_sig: Tuple) -> object | None:
    ...
    # Try loading from disk (survives container restarts)
    ...
    # Build from scratch and persist to disk
